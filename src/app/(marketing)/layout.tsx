  ...
  return (
    <footer className="border-t border-zinc-800/70 py-10">
      <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-6 px-6 md:flex-row md:items-center">
        <div>
          <span className="text-base font-bold">
            <span className="text-emerald-400">Text</span>blast<span className="text-zinc-500">.io</span>
          </span>
      ...
      <p className="mx-auto mt-6 max-w-6xl px-6 text-[11px] text-zinc-600">
        © {new Date().getFullYear()} Textblast.io. Message &amp; data rates may apply. Reply STOP to opt out.
      </p>
    </footer>
  );
}
